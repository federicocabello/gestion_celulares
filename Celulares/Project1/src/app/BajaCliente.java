...
import conexion.BajaClienteMySQL;
...
public class BajaCliente extends javax.swing.JDialog {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        jButton1.setText("Borrar el cliente");
    ...
    private BajaClienteMySQL bcliente = new BajaClienteMySQL();
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        String dni = this.jTextField1.getText();
        String msg = bcliente.bajaCliente(dni);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BajaCliente.class.getName()).log(java.util.logging.Level.SEVERE, null,
                                                                                ex);
