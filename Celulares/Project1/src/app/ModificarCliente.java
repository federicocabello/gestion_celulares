...
import conexion.ModificarClienteMySQL;
...
public class ModificarCliente extends javax.swing.JDialog {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        jLabel1.setText("ACTUALIZAR LOS DATOS DE UN CLIENTE");
        ...
        jLabel5.setText("Nuevo domicilio:");

        jLabel6.setText("Nuevo correo electrónico:");

        jLabel7.setText("Nuevo teléfono:");
    ...
    ModificarClienteMySQL mcliente = new ModificarClienteMySQL();
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String msg = mcliente.modificarCliente(dni,nombre.toUpperCase(),apellido.toUpperCase(),domicilio.toUpperCase(),correo.toUpperCase(),telefono);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModificarCliente.class.getName()).log(java.util.logging.Level.SEVERE,
                                                                                     null, ex);
